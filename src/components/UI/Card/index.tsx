...
const Card: FC<Props> = ({ text }) => {
    ...
    return (
        <div className={styles["card"]}>
            <svg onClick={() => setLike(!isLiked)} className={cn(styles["card__like"], {
                [styles["card__like--liked"]]: isLiked
            })} width="15" height="15" viewBox="0 0 13 12" xmlns="http://www.w3.org/2000/svg">
            ...
            <Link to={'/preview'}><div className={styles["card__img"]}></div></Link>
