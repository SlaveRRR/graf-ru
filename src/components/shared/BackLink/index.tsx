...
const BackLink: FC<Props> = ({mixClass}) => {
    ...
    return (
        ...
        <button className={cn(styles['link'],...mixClass)}  onClick={() => navigate(-1)}>
            <svg className={styles['arrow']} width="6" height="8" viewBox="0 0 6 8" fill="none" xmlns="http://www.w3.org/2000/svg">
